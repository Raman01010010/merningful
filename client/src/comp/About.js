 export default function About(){
  ...
  <div style={{marginLeft:"2%",marginRight:"2%"}} className="row">
    <div className="col-md-6 grid-margin stretch-card">
      <div className="card">
        <div className="card-body">
          <h4 className="card-title">Prajapati Raman</h4>
          <p className="card-description"> Team Memeber</p>
          <p className="card-description"> Contact Info</p>
          <div className="template-demo">
            <h1 className="display-1">
              <a href="https://github.com/Raman01010010">Git Hub </a>
            </h1>
            <h1 className="display-1">
              <a href="https://www.linkedin.com/in/prajapati-raman-6b88a2257">
                Linked In{" "}
              </a>
            </h1>
            <h1 className="display-1">
    ...
    <div className="col-md-6 d-flex align-items-stretch">
      <div className="row">
        <div className="col-md-12 grid-margin stretch-card">
          <div className="card">
            <div className="card-body">
              <h4 className="card-title">CONTRIBUTIONS</h4>
              <p></p>
              <ul>
    ...
    <div className="col-md-6 grid-margin stretch-card">
      <div className="card">
        <div className="card-body">
          <h4 className="card-title">Vivek</h4>
          <p className="card-description"> Team Memeber</p>
          <p className="card-description"> Contact Info</p>
          <div className="template-demo">
            <h1 className="display-1">
    ...
    <div className="col-md-6 grid-margin stretch-card">
      <div className="card">
        <div className="card-body">
          <h4 className="card-title">Sanskar Saxena</h4>
          <p className="card-description"> Team Memeber</p>
          <p className="card-description"> Contact Info</p>
          <div className="template-demo">
            <h1 className="display-1">
          ...
          <div className="card">
            <div className="card-body">
              <div className="row">
                <img
                  width="90%"
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSwsDJDfWn_EqgnUHlxDfhTPT25xfiaaFukLQ&usqp=CAU"
                />
                <div className="col-md-4 d-flex align-items-center">
                  <div className="d-flex flex-row align-items-center">
                    <i className="mdi mdi-compass icon-sm text-danger" />
    ...
    <div className="col-md-6 grid-margin stretch-card">
      <div className="card">
        <div className="card-body">
          <h4 className="card-title">Priyanshu Singh</h4>
          <p className="card-description"> Team Memeber</p>
          <p className="card-description"> Contact Info</p>
          <div className="template-demo">
            <h1 className="display-1">
